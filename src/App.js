...
function App() {
  return (
    <div className="">
      ...
      <section className="relative px-24 pt-40 pb-80">
        ...
        <div className="absolute -bottom-28 left-72 gap-8 flex justify-between items-center z-30">
      ...
      <footer className="relative px-24 pt-44 pb-14 bg-footer text-white flex flex-col justify-center">
        <div className="flex justify-between">
          <div className="">
            <a href="https://flowbite.com/" className="flex items-center pb-8">
              <img src={Logo2} alt="logo1" className="" />
            </a>
            <p>Keep up with the new Releases,</p>
            <p>Beauty Tips and What Emma's been</p>
            <p>Up to</p>
          ...
          <div>
            <p className="mb-6 text-lg font-semibold text-gray-900 uppercase dark:text-white">
              Company
            </p>
            <ul>
              <li className="mb-4">
          ...
          <div>
            ...
            <input
              ...
              className="p-4 rounded-full bg-input my-4"
            />
          </div>
        </div>

        <div className="text-center items-center justify-between pt-24">
          <hr className="w-1/2 my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
